    ...
    try {
      ...
      if (endIndex < raceOptions.length) {
        ...
        initialEmbed.setFooter({
          text: `Page ${page} | Use the "Next Page" button to view more races if any.`,
        });
        sentMessage = await message.channel.send({
          embeds: [initialEmbed],
          components: [raceRow, actionRow],
        });

        const filterr = (i) =>
          (i.customId.startsWith("race_select") ||
          ...
          try {
            ...
            if (i.customId.startsWith("race_select")) {
              ...
              if (selectedRaceValue.startsWith("race-")) {
                ...
                console.log(
                  "classdescription:",
                  racesData[raceNAme]?.description
                );
                console.log(
