...
#[napi]
pub fn calculate_ability_damage(author_atk: f64, author_crit_damage:f64, opponent_defense: f64, author_ability_power: f64) -> f64 {
    println!("haha");
    let damage = (((author_atk*(1.5_f64.powf((author_crit_damage+ 50.0_f64 )/ 100.0_f64 ))).sqrt()).powf((3.0_f64.sqrt()).powf(((850.0 + author_atk) / (450.0 + 1.26 * opponent_defense)).sqrt())))*author_ability_power/100.0_f64;
    damage.floor()
}
